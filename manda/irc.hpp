...
/*   Updated: 2025/05/12 14:57:20 by ncharbog         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define RPL_WELCOME(client, nick, user, host) (std::string(" 001 ") + client + std::string(" :Welcome to the IRC Network, ") + nick + std::string(" [!") + user + std::string("@") + host + std::string("]\r\n"))
# define RPL_YOURHOST(client) (std::string(" 002 ") + )
...
class Irc{
	...
	public:
		Irc(): server_name(":irc.climbers.com") {}
		...
		bool valueExist(std::string value, int mode);
